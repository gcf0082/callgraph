CREATE TABLE if not exists method_call_{appName} (
  ...
  PRIMARY KEY (id),
  INDEX idx_mc_caller_method_hash_{appName}(caller_method_hash),
  INDEX idx_mc_callee_method_hash_{appName}(callee_method_hash, caller_method_hash),
  INDEX idx_mc_caller_simple_name_{appName}(caller_class_name),
  INDEX idx_mc_callee_simple_name_{appName}(callee_class_name)
