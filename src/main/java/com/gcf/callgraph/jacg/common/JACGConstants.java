package com.gcf.callgraph.jacg.common;
...
public class JACGConstants {
    ...
    public static final String[] TABLE_COLUMNS_HANDLED_CLASS_NAME = new String[]{
            DC.CN_FULL_NAME,
            DC.CN_SIMPLE_NAME
    };
    ...
    public static final String FILE_SQL_HANDLED_CLASS_NAME = "handled_class_name.sql";
    ...
    public static final String SQL_KEY_INSERT_HANDLED_CLASS_NAME = "insert_handled_class_name";
    ...
    public static final String TABLE_PREFIX_HANDLED_CLASS_NAME = "handled_class_name_";
